...
pub struct Model<SolverT> {
    ...
    learned_labels: Option<Vec<i32>>,
    c_obj: *mut ffi::Model,
}


fn extract_learned_labels_from_model(model: *mut ffi::Model) -> Option<Vec<i32>> {
    unsafe {
...
pub mod serde {
    ...
    use super::{extract_learned_labels_from_model, Model};
